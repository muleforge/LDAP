...
public class EndpointTestCase extends AbstractMuleTestCase
{
    ...
    public void testSearchStringFromEndpoint1() throws Exception
    {
        ...
        EndpointURI endpoint = new MuleEndpointURI("testendpoint", url, connector,
                null, EndpointURI.ENDPOINT_TYPE_SENDER_AND_RECEIVER, 0, null,
                null);
    ...
    public void testSearchStringFromEndpoint2() throws Exception
    {
        ...
        Connector connector = getConnector();
        UMOEndpoint endpoint = new MuleEndpointURI("testendpoint", url, connector,
                null, UMOEndpoint.ENDPOINT_TYPE_SENDER_AND_RECEIVER, 0, null,
                null);
