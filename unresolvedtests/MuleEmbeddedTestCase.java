...
// FunctionalTestNotificationListener
{
    ...
    public void testDispatchReceiveSearch() throws Exception
    {
        ...
        MuleMessage result = client.receive("ldap://ldap.in", 30000);
    ...
    public void testReceiveTimeout() throws Exception
    {
        ...
        MuleMessage result = client.receive("ldap://ldap.in", 15000);
        ...
        Runnable rec = new Runnable()
        {
            ...
            public void run()
            {
                ...
                try
                {
                    ...
                    while (current < count)
                    {
                        MuleMessage result = client.receive("ldap://ldap.in",
                                15000);
