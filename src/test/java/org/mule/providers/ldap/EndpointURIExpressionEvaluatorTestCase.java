...
public class EndpointURIExpressionEvaluatorTestCase extends AbstractMuleTestCase{
	...
	{
		Object o = ExpressionEvaluatorManager.evaluate("endpointuri:xxx.yyy", new DefaultMuleMessage(""));
		assertNull(o);	
	...
	public void testEval() throws Exception
	{
        ...
        ImmutableEndpoint endpoint = new DefaultOutboundEndpoint(null,url,null,null,"testendpoint",new Properties(),
      		   null,
      		   null,
                true,
                null,
		...
		Object o = ExpressionEvaluatorManager.evaluate("endpointuri:testendpoint.host", new DefaultMuleMessage(""));
		assertNotNull(o);	
	...
	public void testEval2() throws Exception
	{
        ...
        ImmutableEndpoint endpoint = new DefaultOutboundEndpoint(null,url,null,null,"testendpoint",map,
      		   null,
      		   null,
                true,
                null,
		...
		Object o = ExpressionEvaluatorManager.evaluate("endpointuri:testendpoint.params:a", new DefaultMuleMessage(""));
		assertNotNull(o);	
		logger.debug(o);
		assertTrue(o instanceof String);
